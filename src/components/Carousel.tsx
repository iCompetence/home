...
export const Carousel = ({
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      // Calculate max height for mobile
      if (mobile) {
  ...
  }, [slidesToShowDesktop, slidesToShowMobile, items]);
    ...
    >
            ...
            <div className="carousel-container" style={{ overflow: 'visible' }}>
              ...
              >
                {items.map((item, index) => (
                  ...
                  >
                    <div 
                      className="border border-white/10 rounded-none px-6 sm:px-8 pt-6 sm:pt-8 pb-10 sm:pb-14 hover:bg-white/[0.02] transition-colors duration-200"
                      style={{ 
                        height: isMobile ? maxHeight : itemHeight, 
                        minHeight: isMobile ? maxHeight : itemHeight 
                      }}
      ...
      <style>{`
        ...
        .carousel-container {
          ...
          overflow: hidden;
          margin: 0;
          height: ${isMobile ? 'auto' : itemHeight};
        }
