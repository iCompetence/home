...
function PrivacyLedAIPageContent() {
  ...
  // Update solution progress as user scrolls
  ...
  return (
    ...
    >
          ...
          <div className="relative">
            ...
            >
              <span>
                ...
                {activeSection === 'intro-section' && 'Problem'}
                {activeSection === 'services-section' && 'Services'}
                {activeSection === 'guidance-section' && 'Consulting'}
            ...
            {isAnchorDropdownOpen && (
              ...
              >
                ...
                <button
                  ...
                  style={{
                    color: 'var(--gray-white)',
                    opacity: activeSection === 'intro-section' ? 1 : 0.6,
                    fontSize: '14px',
                    fontWeight: '500',
                    background: 'none',
                    border: 'none',
      ...
      >
        AI is ready. Your data is not.
        <br /><br />
        AI is becoming a fundamental driver of efficiency and competitiveness. But every organization working with sensitive data faces the same barrier: AI cannot go where the data lives — and the data cannot go where the AI runs.
        <br /><br />
        <span style={{
          background: 'linear-gradient(90deg, #E19B74 0%, #D476CD 100%)',
          ...
          transform: `translateY(${(1 - solutionProgress) * 50}px)`,
          display: 'inline-block'
        }}>
          The solution: Bring AI to your data.
        </span>
      </StaticText>
      ...
      <Carousel
        id="services-section"
        title="We bring AI into your organisation"
        subline="We design and implement privacy-led AI systems that run securely inside your infrastructure — tailored to your workflows, your governance and your industry."
        items={[
          {
            title: "Privacy-led AI Agents",
            description: "AI agents that operate inside your environment — retrieving information, preparing decisions and supporting teams without exposing sensitive data. Fully auditable, domain-adapted and aligned with your internal tools and access controls."
          },
          {
            title: "AI Automation",
            description: "We automate processes across your organisation using safe, internal AI workflows. From document handling to operational tasks, everything runs where your data already lives — compliant by design and integrated into your existing systems."
          },
          {
            title: "AI Hosting",
            description: "We host and operate open-weight AI models inside your infrastructure (on-prem, VPC or private cloud). Secure, scalable and tailored to your governance, giving you full control over how AI is deployed, monitored and maintained."
          }
        ]}
