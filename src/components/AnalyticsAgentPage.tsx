...
const discoverImages = [
  { src: '/assets/analytics-agent/dashboard.png', alt: 'Analytics Agent Dashboard' },
  { src: '/assets/analytics-agent/chat.png', alt: 'Analytics Agent Chat' },
  { src: '/assets/analytics-agent/visualization.png', alt: 'Analytics Agent Visualization' },
  { src: '/assets/analytics-agent/connectors.png', alt: 'Analytics Agent Connectors' },
];
...
function AnalyticsAgentPageContent() {
  ...
  const anchorItems = [
    { id: 'hero', label: t('analyticsAgent.anchor.intro'), number: '01' },
    { id: 'intro-section', label: t('analyticsAgent.anchor.challenge'), number: '02' },
    { id: 'what-section', label: t('analyticsAgent.anchor.whatIs'), number: '03' },
    { id: 'features-section', label: t('analyticsAgent.anchor.features'), number: '04' },
    { id: 'how-it-works-section', label: t('analyticsAgent.anchor.inAction'), number: '05' },
    { id: 'cta-footer-section', label: t('analyticsAgent.anchor.contact'), number: '06' }
  ];
        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8" style={{ position: 'relative', zIndex: 1 }}>
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                {t('analyticsAgent.hero.subtitle')}
              </p>
            </div>
          </div>
        </section>
    ...
    >
      ...
      >
        <span style={{ color: '#E19B74', fontStyle: 'italic' }}>
          {t('analyticsAgent.intro.quote')}
        </span>
        <span style={{ color: '#E19B74' }}>{t('analyticsAgent.intro.quoteAuthor')}</span>
        <br /><br />
        {t('analyticsAgent.intro.p1')}
        <br /><br />
        {t('analyticsAgent.intro.p2')}
        <br /><br />
        <span style={{ fontWeight: '700' }}>{t('analyticsAgent.intro.p3')}</span>
      </StaticText>
      ...
      >
        <div className="hero-image-container">
          ...
          >
            <img
              src="/assets/analytics-agent/dashboard.png"
              alt="Analytics Agent Dashboard"
              className="w-full h-auto"
              style={{ display: 'block' }}
            />
          </div>
      ...
      <section id="features-section" className="relative z-10 py-16 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#012332' }}>
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              {t('analyticsAgent.features.title')}
            </h2>
          </div>
        </div>
      </section>

      {/* Card 1 - Any Data Source */}
      <ImageText
        id="any-data-source"
        title={t('analyticsAgent.card1.title')}
        description={t('analyticsAgent.card1.description')}
        layout="image-left"
        image="/assets/analytics-agent/connectors.png"
        imageAlt={t('analyticsAgent.card1.title')}
      />

      {/* Card 2 - Natural Language */}
      <ImageText
        id="natural-language"
        title={t('analyticsAgent.card2.title')}
        description={t('analyticsAgent.card2.description')}
        layout="image-right"
        image="/assets/analytics-agent/chat.png"
        imageAlt={t('analyticsAgent.card2.title')}
      />

      {/* Card 3 - Visual Analytics */}
      <ImageText
        id="visual-analytics"
        title={t('analyticsAgent.card3.title')}
        description={t('analyticsAgent.card3.description')}
        layout="image-left"
        image="/assets/analytics-agent/visualization.png"
        imageAlt={t('analyticsAgent.card3.title')}
      />

      {/* Card 4 - Knowledge Base */}
      <ImageText
        id="knowledge-base"
        title={t('analyticsAgent.card4.title')}
        description={t('analyticsAgent.card4.description')}
        layout="image-right"
        image="/assets/analytics-agent/knowledge.png"
        imageAlt={t('analyticsAgent.card4.title')}
      />

      {/* Card 5 - GA4 Use Case */}
      <ImageText
        id="ga4-use-case"
        title={t('analyticsAgent.card5.title')}
        description={t('analyticsAgent.card5.description')}
        layout="image-left"
        image="/assets/analytics-agent/ga4.png"
        imageAlt={t('analyticsAgent.card5.title')}
      />

      {/* Card 6 - Enterprise Ready */}
      <ImageText
        id="enterprise-ready"
        title={t('analyticsAgent.card6.title')}
        description={t('analyticsAgent.card6.description')}
        layout="image-right"
        image="/assets/analytics-agent/enterprise.png"
        imageAlt={t('analyticsAgent.card6.title')}
      />
