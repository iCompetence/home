    ...
    <main className="min-h-screen text-white">
      ...
      <div className={`fixed top-[4.5rem] sm:top-[5.25rem] md:top-[5.75rem] lg:top-[6.25rem] xl:top-[6.75rem] 2xl:top-[7.5rem] right-4 sm:right-5 md:right-6 lg:right-7 xl:right-8 2xl:right-10 z-30 transition-all duration-300 ${
        ...
        <button
          ...
          className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 xl:w-12 xl:h-12 2xl:w-14 2xl:h-14 bg-[#161925] rounded-full flex items-center justify-center hover:bg-[#0099CC] transition-colors"
        >
        ...
        <div className="fixed inset-0 w-full h-full z-0 text-white">
          ...
          <nav className={`relative z-20 transition-all duration-1000 ease-in-out ${
            ...
            <div className="hidden lg:flex flex-wrap justify-start space-x-3">
              ...
              <Link href="https://www.icompetence.de/blog" target="_blank" rel="noopener noreferrer" className="border border-[#E0FBFC] text-[#E0FBFC] hover:bg-[#E0FBFC] hover:text-[#0099cc] px-5 xl:px-6 py-2 rounded-full text-lg xl:text-xl font-theinhardt">
                Unser Blog
              </Link>
